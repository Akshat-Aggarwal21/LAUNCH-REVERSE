...
def render_why_this_insight_card(hyp: Dict[str, Any]):
    ...
    Uses render_html to ensure pristine HTML rendering in Streamlit with zero tag leakage.
    """
    confidence_color = {
        "LOW": "#f43f5e",
        "MEDIUM": "#f59e0b",
    ...
    assumptions_html = "".join(f"<li>{a}</li>" for a in hyp.get("assumptions", []))
...
<div style="background: #0f172a; border: 1px solid #1e293b; border-radius: 8px; padding: 20px; margin-top: 10px; margin-bottom: 20px;">
    <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #1e293b; padding-bottom: 12px; margin-bottom: 16px;">
        <div>
            <span style="font-family: 'JetBrains Mono', monospace; font-size: 0.72rem; color: #94a3b8; text-transform: uppercase;">EPISTEMIC AUDIT // WHY THIS INSIGHT?</span>
            <h3 style="font-family: 'JetBrains Mono', monospace; font-size: 1.05rem; color: #f8fafc; margin: 4px 0 0 0;">{hyp['title']}</h3>
        </div>
        <div style="text-align: right;">
            <span style="font-family: 'JetBrains Mono', monospace; font-size: 0.7rem; color: #64748b; display: block;">CONFIDENCE</span>
            <span style="font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 0.95rem; color: {confidence_color};">{hyp.get('confidence_level', 'LOW')}</span>
        </div>
    </div>
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
        ...
        <div>
            <div style="margin-bottom: 16px;">
                <span style="font-family: 'JetBrains Mono', monospace; font-size: 0.78rem; font-weight: 600; color: #4ade80; text-transform: uppercase;">
                    ✓ Supporting Evidence
                </span>
                <div style="margin-top: 8px; font-family: 'JetBrains Mono', monospace; font-size: 0.82rem; color: #cbd5e1; line-height: 1.6;">
            ...
            <div style="margin-bottom: 16px;">
                <span style="font-family: 'JetBrains Mono', monospace; font-size: 0.78rem; font-weight: 600; color: #fb7185; text-transform: uppercase;">
                    ⚠ Counterevidence & Exceptions
                </span>
                <div style="margin-top: 8px; font-family: 'JetBrains Mono', monospace; font-size: 0.82rem; color: #cbd5e1; line-height: 1.5;">
        ...
        <div>
            <div style="margin-bottom: 16px;">
                <span style="font-family: 'JetBrains Mono', monospace; font-size: 0.78rem; font-weight: 600; color: #fbbf24; text-transform: uppercase;">
                    • Explicit Assumptions
                </span>
            ...
            <div style="background: rgba(244, 63, 94, 0.08); border-left: 3px solid #f43f5e; padding: 10px 12px; border-radius: 0 4px 4px 0; margin-bottom: 14px;">
                <span style="font-family: 'JetBrains Mono', monospace; font-size: 0.72rem; font-weight: 700; color: #f43f5e; text-transform: uppercase;">
            ...
            <div style="border-top: 1px dashed #334155; padding-top: 10px;">
                <span style="font-family: 'JetBrains Mono', monospace; font-size: 0.72rem; color: #38bdf8; text-transform: uppercase; font-weight: 600;">
